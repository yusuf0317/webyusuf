        ...
        <div className="mt-20 flex mx-36">
          <div>
            ...
            <div className="mt-10 block">
              ...
              <div className=" mb-3">
                <input type="text" placeholder="beritahu nama organisasi kamu ..." className="text-[18px] w-[500px] h-[60px] border-[#9B9B9B] border outline-none text-[#9B9B9B] px-5 rounded-[10px]" />
              </div>
              <div className=" mb-3">
                <input type="text" placeholder="Beritahu kami peranmu di dalam organisasi ..." className="text-[18px] w-[500px] h-[60px] border-[#9B9B9B] border outline-none text-[#9B9B9B] px-5 rounded-[10px]" />
              </div>
              <div className=" mb-3">
